...
const LoginForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100" style={{ width: '100%',
      height: '100vh',
      backgroundImage: 'linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.1)), url(https://th.bing.com/th/id/OIP.6rSbyRpCjEVdDG2ZAyWoagHaCs?rs=1&pid=ImgDetMain)',
