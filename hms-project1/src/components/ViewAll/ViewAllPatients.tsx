...
const ViewAllPatients: React.FC = () => {
  ...
  const handleRegisterChange=(e: { target: { name: any; value: any; }; }) => {
    ...
    const validateForm = (): string[] => {
      ...
      if (!patientData.firstName.trim()) errorsList.push("First Name is required.");
      if (!patientData.lastName.trim()) errorsList.push("Last Name is required.");
      if (!patientData.dateOfBirth.trim()) errorsList.push("Date of Birth is required.");
