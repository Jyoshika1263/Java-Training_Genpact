  ...
  const getNavItems = () => {
    ...
    if (user?.role === 'admin') {
      return [
        ...
        { name: 'Staff', path: '/staff', icon: <UserCircle size={20} /> },
    ...
    if (user?.role === 'patient') {
      return [
        ...commonItems,
        { name: 'Medical History', path: '/medical-records', icon: <ClipboardList size={20} /> },
        { name: 'Prescriptions', path: '/prescriptions', icon: <Pill size={20} /> },
        //{ name: 'Lab Reports', path: '/lab-reports', icon: <Flask size={20} /> },
        { name: 'Billing', path: '/patientbilling', icon: <CreditCard size={20} /> },
