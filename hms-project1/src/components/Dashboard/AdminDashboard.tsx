    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <a href="/staff" className="font-medium text-primary-600 hover:text-primary-900">
                View all
              </a>
            </div>
          </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          ...
          <div className="bg-gray-50 px-5 py-3">
            <div className="text-sm">
              <a href="/appointments1" className="font-medium text-primary-600 hover:text-primary-900">
                View all
              </a>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-lg font-medium text-gray-900">Rs.{totalRevenue.toFixed(2)}</div>
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd>
                    <div className="text-lg font-medium text-gray-900">Rs.{pendingRevenue.toFixed(2)}</div>
                  </dd>
                </dl>
              </div>
            </div>
