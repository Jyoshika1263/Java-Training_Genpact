      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
          <h3 className="text-lg leading-6 font-medium text-gray-900">
            {user?.role === 'patient' ? 'Your Medical History' : 'Patient Records'}
          </h3>
        </div>
                ...
                <div key={record.id} className="px-4 py-4 sm:px-6 hover:bg-gray-50">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      <span className="font-medium text-gray-600">Appointment Type</span> {record.diagnosis}
                    </p>
                  </div>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      <span className="font-medium text-gray-600">Reason:</span> {record.diagnosis}
                    </p>
                  </div>
                </div>
              );
